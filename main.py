...
csv_string = pm.midi_to_csv("doremi.mid")
...
markov_new_notes = []
key= random.choice(list(chain.items()))
...
csv_string1 = pm.midi_to_csv("doremi.mid")
...
with open("london.mid", "wb") as output_file:
